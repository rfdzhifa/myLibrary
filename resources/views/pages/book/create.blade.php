                    ...
                    <div class="card-body">
                      <form action="{{ route('book.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          ...
                          is-invalid
                          @enderror"
                          id="basic-default-fullname" placeholder="The Lords of the Rings" name="title"/>
                          @error('title')
                        ...
                        <div class="mb-3">
                          ...
                          is-invalid
                          @enderror" 
                          id="basic-default-fullname" placeholder="John Doe" name="author"/>
                          @error('author')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                          ...
                          is-invalid
                          @enderror" 
                          id="basic-default-fullname" placeholder="John Doe" name="publisher"/>
                          @error('publisher')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                          ...
                          is-invalid
                          @enderror" id="basic-default-fullname" placeholder="John Doe" name="year"/>
                          @error('year')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                          ...
                          is-invalid
                          @enderror" id="basic-default-fullname" placeholder="John Doe" name="isbn"/>
                          @error('isbn')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                          ...
                          is-invalid
                          @enderror" id="inputGroupFile02" name="cover"/>
                          @error('cover')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            is-invalid
                            @enderror" id="inputGroupSelect01" name="category">
